...
public class AutoBlueLeft extends StarterAuto {
    ...
    public void runOpMode() {
        ...
        // Pose(40,57.5,Math.PI/2),true))&&opModeIsActive()){
        // asyncPositionCorrector();
        // }
        // while((!driveToPointAsync(new
        // Pose(40,11,Math.PI/2),true))&&opModeIsActive()){
        // asyncPositionCorrector();
        // }
        // while((!driveToPointAsync(new
        // Pose(-58.5,11,Math.PI/2),true))&&opModeIsActive()){
        // asyncPositionCorrector();
        // }
        // turnRobot(Math.PI/8);
        // turnRobot(Math.PI/2);
        ...
        // motorsStop();
        // while((!driveToPointAsync(new
        // Pose(58,57.5,-Math.PI/2),true))&&opModeIsActive()){
        // asyncPositionCorrector();
        // }
